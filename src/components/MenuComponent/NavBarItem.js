...
import BaseDivider from '../Utilities/BaseDivider';
import BaseIcon from '../Utilities/BaseIcon';
import UserAvatarCurrentUser from '../Utilities/UserAvatarCurrentUser';
import NavBarMenuList from './NavBarMenuList';
import { useAppDispatch, useAppSelector } from '../../redux/hooks';
import { setDarkMode } from '../../redux/styleSlice';
  ...
  const NavBarItemComponentContents = (
    <>
      ...
      >
        ...
        {item.icon && (
          <BaseIcon Icon={item.icon} className='transition-colors' />
        )}
        <span
        ...
        {item.menu && (
          <BaseIcon
            Icon={isDropdownActive ? BiChevronUp : BiChevronDown}
